...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=5009915795";
...
v16.Home:AddButton({
    Title = "Remember:",
    Description = "This is not the real Banana Cat Hub, but a fake version made by thịnh Roblox hack.",
    Callback = function()
        setclipboard("quên");
    end
});
    ...
    task.spawn(function()
        while task.wait() do
            pcall(function()
                ...
                if (v793 == "http://www.roblox.com/asset/?id=9709149052") then
                    FullMoonStatus = "100%";
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://5009915795") then
                    return v729;
                end
            end
        end
